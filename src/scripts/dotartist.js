class DotArtistPixel extends HTMLElement {
  ...
  setValue(value) {
    ...
    if (value > 0) this.innerText = value;
  }
}
    ...
    for (let row = 0; row < this.rowCount; row++) {
      for (let col = 0; col < this.colCount; col++) {
        ...
        if (index < pixelArray.length) {
          ...
          if (row === lastRow || (row === lastRow - 1 && col > lastCol)) {
...
class DotArtistConfigOptions extends HTMLElement {
  constructor() {
    ...
    this.append(this.dropdown, ...this.dropdownOptions.values());
...
customElements.define("dot-artist-toggle-option", ToggleableDotArtistOption, {
  extends: "img",
});
customElements.define("dot-artist-dropdown", DotArtistDropDownOption, {
  extends: "img",
});
customElements.define("dot-artist-highlight", DotArtistHighlightOption, {
  extends: "img",
});
customElements.define("dot-artist-number-view", DotArtistNumberViewerOption, {
  extends: "img",
});
customElements.define("dot-artist-copy", DotArtistCopyOption, {
  extends: "img",
});
