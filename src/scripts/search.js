  ...
  constructor(
    ...
    this.addEventListener("change", () => {
      document.dispatchEvent(
        new CustomEvent("languageUpdate", { detail: this.getValue() }),
      );
...
class SearchBar extends HTMLElement {
  constructor() {
    ...
    this.append(icon, this.searchInput, this.gameSelector, this.languageInput);
  }
}
  ...
  constructor(json) {
    ...
    for (const scriptObject of json) {
      ...
      searchResult.onSelect(
        ScriptGroupList.instance.addScriptGroup.bind(ScriptGroupList.instance),
      );
